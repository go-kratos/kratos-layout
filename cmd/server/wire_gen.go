...
func wireApp(confServer *conf.Server, confData *conf.Data, logger *slog.Logger) (*kratos.App, func(), error) {
	...
	grpcServer := server.NewGRPCServer(confServer, greeterService, routeGuideService, logger)
	httpServer := server.NewHTTPServer(confServer, greeterService, routeGuideService, logger)
